"""
Django settings for system_core project.
...
SECRET_KEY = 'django-insecure-5$5td@kbp@k_nzxkaob!)7)64@1p$zj#hn)71ye=7n8031&p_*'
...
WSGI_APPLICATION = 'system_core.wsgi.application'
